...
//    }
    ...
    if(self.navigationController!=nil){
        self.navigationController.navigationBar .frame  = self.navigationController.navigationBar.frame;
...
- (void)expropriateImageView
{
    ...
    _bgView.alpha = 0;
//    self.navigationController.navigationBar .transform = CGAffineTransformMakeTranslation(0, -self.navigationController.navigationBar .height);
...
//    self.navigationController.navigationBar .frame = [window convertRect:self.navigationController.navigationBar .frame fromView:self.navigationController.navigationBar.superview];
...
- (void)swapToolBarWithEditting:(BOOL)editting
{
    ...
    if(self.currentTool){
        ...
        [self.navigationController.navigationBar pushNavigationItem:item animated:(self.navigationController==nil)];
    }
    else{
        [self.navigationController.navigationBar  popNavigationItemAnimated:(self.navigationController==nil)];
    }
}
